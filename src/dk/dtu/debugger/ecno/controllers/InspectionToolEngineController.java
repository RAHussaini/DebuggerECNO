...
public class InspectionToolEngineController extends SelectionAdapter implements 
IController,
dk.dtu.imm.se.ecno.engine.ECNODebugger,
IInspectionToolEngineController
{

	//	protected static Logger log = zesttreeviewtest.util.Logger.getLog();

	private static InspectionToolEngineController instance;
	...
	private InspectionToolEngineController(){
	}

	public static IInspectionToolEngineController getInstance(){
		if(instance == null){
			System.err.println("new instance");
			return (instance = new InspectionToolEngineController());
		}
		return instance;
	}
